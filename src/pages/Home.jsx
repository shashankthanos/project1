...
// filtering all the data from the API
    ...
    return (
        <>
            <Header user={user} social={filteredSocialHandles} />
            <About user={user} social={filteredSocialHandles}/>
            <Skills  skill={sortedFilteredSkills}/>
            <Timeline education={filteredEducation} experience={filteredExperience}/>
            <Projects project={sortedFilteredProject}/>
